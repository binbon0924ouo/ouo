...
public class BulletItem extends OuoModElements.ModElement {
	@ObjectHolder("ouo:bullet")
	public static final Item block = null;
	public BulletItem(OuoModElements instance) {
		super(instance, 11);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(ModItemGroup.tab).maxStackSize(64).rarity(Rarity.UNCOMMON));
